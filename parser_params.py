...
def add_parser_params(parser):
    ...
    parser.add_argument('--loop_factor', default=1, type=int, help='The loop factor for training')
    parser.add_argument('--is_distributed', action='store_true', help='Whether to use distributed training')
    ...
    if args.epochs in [10, 90, 100, 120, 270, 350]:
        args.slow_start_epochs = 5
